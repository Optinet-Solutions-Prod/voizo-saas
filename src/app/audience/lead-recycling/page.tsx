// src/app/audience/lead-recycling/page.tsx
//
// MOVED 2026-09-04: /audience now holds the new Audience reporting tab. This page kept its
// code byte-for-byte and moved to /audience/lead-recycling, unlinked from the sidebar. It
// manages `local_segments`, which has never held a row in production, so nothing was using it.
// Delete the folder when Jasiel says so.
//
...
export default function AudiencePage() {
  ...
  return (
    ...
    <div className="p-4 max-w-[1600px] mx-auto w-full grid grid-cols-[minmax(0,1fr)] gap-4">
